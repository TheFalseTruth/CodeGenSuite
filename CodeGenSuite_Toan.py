...
class CheckCodeGenSuite(unittest.TestCase):
    ...
    def test_int_2(self):
        """Simple program: int main() {} """
        input = """procedure main(); begin putInt(100 + 1); end"""
        expect = "101"
        self.assertTrue(TestCodeGen.test(input,expect,2))

    def test_int_3(self):
        """Simple program: int main() {} """
        input = """procedure main(); begin putInt(100 + 1 + 2); end"""
        expect = "103"
        self.assertTrue(TestCodeGen.test(input,expect,3))

    def test_int_4(self):
        """Simple program: int main() {} """
        input = """procedure main(); begin putInt(100*11); end"""
        expect = "1100"
        self.assertTrue(TestCodeGen.test(input,expect,4))

    def test_int_5(self):
        """Simple program: int main() {} """
        input = """procedure main(); begin putInt(6 diV 4); end"""
        expect = "1"
        self.assertTrue(TestCodeGen.test(input,expect,5))

    def test_int_6(self):
        """Simple program: int main() {} """
        input = """procedure main(); begin putInt(6 mod 4); end"""
        expect = "2"
        self.assertTrue(TestCodeGen.test(input,expect,6))

    def test_float_1(self):
        """Simple program: int main() {} """
        input = """procedure main(); begin putFloat(6/4); end"""
        expect = "1.5"
    ...
    def test_bool_3(self):
        """Simple program: int main() {} """
        input = """procedure main(); begin putBool(True and false); end"""
        expect = "false"
        self.assertTrue(TestCodeGen.test(input,expect,10))

    def test_bool_4(self):
        """Simple program: int main() {} """
        input = """procedure main(); begin putBool(1 < 2); end"""
        expect = "true"
        self.assertTrue(TestCodeGen.test(input,expect,11))

    def test_bool_5(self):
        """Simple program: int main() {} """
        input = """procedure main(); begin putBool(1 + 2 <= 3); end"""
        expect = "true"
    ...
    def test_bool_6(self):
        """Simple program: int main() {} """
        input = """procedure main(); begin putBool(not false); end"""
        expect = "true"
        self.assertTrue(TestCodeGen.test(input,expect,15))

    def test_bool_7(self):
        """Simple program: int main() {} """
        input = """procedure main(); begin putBool((1.2 >= 2.2) and (1.2 = 2.2)); end"""
        expect = "false"
